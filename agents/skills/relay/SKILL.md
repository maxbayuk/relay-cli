...
description: >-
  ...
  Requires relay-cli: npm install -g @relayprotocol/relay-cli
...
This skill ships with relay-cli. If the CLI is installed, you're ready to go.

```bash
npm install -g @relayprotocol/relay-cli
# or use without installing:
npx @relayprotocol/relay-cli <command>
```
...
- CLI repo: https://github.com/relayprotocol/relay-cli
